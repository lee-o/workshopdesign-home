...
//
$projets = $bdd->query('SELECT * FROM _contact order by id ASC');
...
while ($donnees = $projets->fetch())
{
	if($donnees['id'] == 1){
		...
		echo "<div id=\"ficheAbout\">";
			echo "<h2 id=\"title\">";
				echo "<FORM method=\"post\" action=\"upDateContact.php\" enctype=\"multipart/form-data\" onSubmit=\"\">";
					echo "<div id=\"interligne\"></div>";
					echo "Texte de la page Contact:<br><textarea name=\"desc\" rows=\"20\" cols=\"80\">".$donnees['description']."</textarea><br>";				
					echo "<div id=\"interligne\"></div>";
